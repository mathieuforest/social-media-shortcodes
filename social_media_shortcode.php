<?php 
/*
Plugin Name: Social network shortcode
...
function social_link_sc($service, $link, $atts, $icon){
   ...
   return "<a href=\"$link$name\" title=\"$name's $service profile\"><img src=\"$blog_url/$icon\"></a>";
}
...
function mail_sc($atts){ 
   return social_link_sc('Mail', 'mailto:', $atts, 'images/icons/social/white/mail.png');
}
...
function linkedin_sc($atts){ 
   return social_link_sc('Linkedin', 'http://www.linkedin.com/in/', $atts, 'images/icons/social/white/linkedin.png');
}
